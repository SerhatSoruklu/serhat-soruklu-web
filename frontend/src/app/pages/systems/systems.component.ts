...
export class SystemsComponent {
  ...
  readonly systemCards: readonly SystemHubCard[] = [
    ...
    },
    {
      ...
      description: 'A boundary model for stopping unsupported semantic drift across inputs, claims, and constraints.',
      status: 'Research / architecture model',
      chips: ['Boundary enforcement', 'Drift prevention', 'Safe failure'],
